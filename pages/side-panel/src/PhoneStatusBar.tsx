...
const PhoneStatusBar = ({ className, leading }: PhoneStatusBarProps) => {
  ...
  return (
    <header className={className ? `phone-status ${className}` : 'phone-status'}>
      ...
      <div className="phone-status__right" aria-hidden="true">
        ...
        <span
          className={
            battery.charging ? 'phone-status__battery phone-status__battery--charging' : 'phone-status__battery'
          }
