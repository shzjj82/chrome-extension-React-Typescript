import { generateLearningContent, parseSubtitleFile } from './learning';
...
const StudyPanel = ({ isLight, onBack }: StudyPanelProps) => {
  ...
  return (
    <div className={cn('sm-shell', !isLight && 'sm-shell--dark')}>
      <header className="sm-shell__header sm-shell__header--tabs-only">
